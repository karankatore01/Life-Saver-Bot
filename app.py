...
# For Coronavirus
with open(r"Projects\Natural language processing\Impulse Life Saviour\Coronavirus_logistic", "rb") as f:
    logisticRegression = pickle.load(f)


# For Chronic kidney disease
with open(r"Projects\Natural language processing\Impulse Life Saviour\CKD_Model", "rb") as f:
    decisionTree = pickle.load(f)

# For Heart Disease
with open(r"Projects\Natural language processing\Impulse Life Saviour\HeartDisease", "rb") as f:
...
def Contact():
    if request.method == "POST":
        ...
        sender = "rvkhatale@gmail.com"
        receiver = "rvkhatale@gmail.com"
        password = "rvkhatale@1"
